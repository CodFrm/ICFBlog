...
<h2>文章管理</h2>
<div class="tools">
    <a href="#"><i class="fa fa-plus fa-2x pull-right"></i></a>
</div>
<div class="article-list">
    {foreach getArticle() as $value}
        <div class="article-admin">
            <p class="article-title"><a href="{url('article->index','id='.$value['articleid'])}" target="_blank">{$value['title']}</a></p>
            <p class="article-content">{getSection($value['content'])}</p>
            <a href="{url('admin->index->edit','id='.$value['articleid'])}"><i class="fa fa-pencil-square-o fa-2x"></i></a>
